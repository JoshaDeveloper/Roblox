        ...
        ballFolder:GetChildren()[1]:GetAttributeChangedSignal('target'):Connect(function()
            ...
            if ballTarget == lpName then
                ...
                if timeToImpact < 0.7 then
                    ...
                    if timeToImpact < 0.5 or (character.HumanoidRootPart.Position - v.Position).Magnitude <= 18 then
                        is_spam_needed = true
...
--[[
    loadstring(game:HttpGet("https://raw.githubusercontent.com/JoshaDeveloper/Roblox/main/raw.lua"))()
]]
