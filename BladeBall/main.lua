...
loadstring(game:HttpGet("https://raw.githubusercontent.com/clgtmm/Kavo-UI/main/hihi.lua"))()
...
local isCircleTP = getgenv().config["CircleTeleport"] or false
    ...
    if ball then
        ...
        do
            ...
            character.HumanoidRootPart.CFrame = CFrame.new(ball.Position + Vector3.new(
                12 * math.cos(angle), 0,  12 * math.sin(angle)
            ))
        end
        end
    end
