    ...
    if v:GetAttribute("realBall") == true then
        v:GetAttributeChangedSignal('target'):Connect(function()
            ...
            if ballTarget == lpName then
                ...
                if (alive[ballTarget] - v.Position).Magnitude > 25 then
                    is_spam_needed = false
                end
            end
        end)
...
--[[
    loadstring(game:HttpGet("https://raw.githubusercontent.com/JoshaDeveloper/Roblox/main/budaitao.lua"))()
]]
