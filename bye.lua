    ...
    if v:GetAttribute("realBall") == true then
        ballFolder:GetChildren()[1]:GetAttributeChangedSignal('target'):Connect(function()
            ...
            if ballTarget == lpName then
                ...
                if timeToImpact < 0.72 then
                    print("close detected")
                    if timeToImpact < 0.6 or (character.HumanoidRootPart.Position - v.Position).Magnitude <= 22 then
                        is_spam_needed = true
...
--[[
    loadstring(game:HttpGet("https://raw.githubusercontent.com/JoshaDeveloper/Roblox/main/hi.lua"))()
]]
